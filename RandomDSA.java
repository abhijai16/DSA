...
public class RandomDSA{
    public static void main(String[] args) {
        ...
        int[] easy = {1, 268, 1480, 1672, 1470, 1431, 1512, 1295, 1365, 832, 1920, 1929, 744, 704, 867, 448, 645, 136, 191, 1342, 3658, 1389, 1832, 1732, 66, 26, 724, 976, 219, 766};
        int[] medium = {75, 189, 34, 852, 162, 33, 1011, 2226, 287, 442, 238, 17, 1985, 167, 15, 16, 31, 48, 11, 54, 59, 49, 1329, 498, 2007, 985, 334, 523, 3, 22, 835, 1706, 36};
